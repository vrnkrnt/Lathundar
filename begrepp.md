...
[JavaScript Introduktion](https://developer.mozilla.org/en-US/docs/Web/JavaScript/A_re-introduction_to_JavaScript)

[mLab - Databas för MongoDB](https://mlab.com)

[React - Intro](https://reactjs.org/tutorial/tutorial.html)
[React - How to learn React](https://www.lullabot.com/articles/how-to-learn-react)
...
VRF (Cisco)
`Virtual Roaming and Forwarding. En nätverksswitch kan innehålla fler VRF er och varje VRF har ett system kopplat till sig. Dokummenteras för att ha koll på vilka system som sitter i vilka VRFer och i vilka nätverksswitchar.`
